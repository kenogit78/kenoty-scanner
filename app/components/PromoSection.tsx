  ...
  return (
    <div className="mx-auto max-w-screen-2xl px-8 md:px-5 my-10">
      <section className="mt-20">
        <h1 className="text-center text-white font-bold text-lg md:text-4xl max-w-screen-lg mx-auto">
          Here’s what you get
        </h1>
        ...
        <div>
          <h1 className="text-center text-white font-bold text-lg md:text-3xl max-w-screen-lg mx-auto">
            ALL FROM ONE SIMPLE SCAN.
          </h1>

          <p className="text-center text-white font-bold text-lg md:text-2xl max-w-screen-lg mx-auto mt-10">
